fid = fopen('ckl_data_polydepth++/benchmark1b/PDg_100000.txt');
...
fid_combine = fopen('ckl_data_polydepth++/benchmark1b/pd_result_combine_PDg.txt');
pds_combine = [];
...
set(gca,'FontSize',15)
plot( (1:n), pds_gd(1:n), 'g', (1:n), pds(1:n), 'r', (1:n), pds_polydepth(1:n), 'm', (1:n), pds_combine(1:n), 'b', 'LineWidth', 2);
legend('Ground truth', 'Our method', 'PolyDepth++', 'Combination')
xlabel('frame id')
ylabel('PD_g')
axis tight
%plot((1:n), pds(1:n), (1:n), pds_combine(1:n));
%plot((1:n), pds(1:n), (1:n), pds_gd(1:n));
%plot((1:n), pds_combine(1:n), (1:n), pds_gd(1:n));
%plot(pds_polydepth(1:n),  (1:n), pds_gd(1:n));