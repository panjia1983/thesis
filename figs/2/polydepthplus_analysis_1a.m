fid = fopen('ckl_data_polydepth++/benchmark1a/PDg_100000.txt');
...
fid_polydepth = fopen('ckl_data_polydepth++/benchmark1a/pd_result_coherence.txt');
pds_polydepth = [];
...
fid_combine = fopen('ckl_data_polydepth++/benchmark1a/pd_result_combine_PDg.txt');
pds_combine = [];
