fid = fopen('ckl_data_polydepth/benchmark1a/PD_100000.txt');
...
fid_polydepthplus = fopen('ckl_data_polydepth++/benchmark1a/pd_result_coherence++.txt');
pds_polydepthplus = [];
...
fid_combine = fopen('ckl_data_polydepth/benchmark1a/pd_result_combine.txt');
pds_combine = [];
