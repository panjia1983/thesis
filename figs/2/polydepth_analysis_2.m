fid = fopen('ckl_data_polydepth/benchmark2/PDg_PDt_100000.txt');
...
fid_polydepthplus = fopen('ckl_data_polydepth++/benchmark2/pd_result_coherence++.txt');
pds_polydepthplus = [];
...
set(gca,'FontSize',15)
plot((1:n), pds(1:n), 'r', (1:n), pds_polydepth(1:n), 'k', (1:n), pds_polydepthplus(1:n), 'm', (1:n), pds_combine(1:n), 'b', 'LineWidth', 2);
legend('Our method', 'PolyDepth', 'PolyDepth++', 'Combination')
xlabel('frame id')
ylabel('PD_t')
xlim([1,n])
